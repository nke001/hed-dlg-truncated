...
def protoype_reddit_VHRED():
    state = prototype_state()

    # define reddit path
    state['train_dialogues'] = "reddit_politics/Training.dialogues.pkl"
    state['test_dialogues'] = "reddit_politics/Test.dialogues.pkl"
    state['valid_dialogues'] = "reddit_politics/Validation.dialogues.pkl"
    state['dictionary'] = "reddit_politics/Training.dict.pkl"
    state['save_dir'] = "Output"
